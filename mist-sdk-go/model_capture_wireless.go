...
// checks if the CaptureWireless type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CaptureWireless{}

// CaptureWireless Initiate a Wireless Packet Capture
type CaptureWireless struct {
	ApMac NullableString `json:"ap_mac,omitempty"`
	Band *CaptureWirelessBand `json:"band,omitempty"`
	// duration of the capture, in seconds
	Duration *int32 `json:"duration,omitempty"`
	Format *CaptureWirelessFormat `json:"format,omitempty"`
	...
	Type CaptureWirelessType `json:"type"`
	// WLAN ID
	WlanId *string `json:"wlan_id,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _CaptureWireless CaptureWireless
...
func NewCaptureWireless(type_ CaptureWirelessType) *CaptureWireless {
	this := CaptureWireless{}
	var band CaptureWirelessBand = CAPTUREWIRELESSBAND__24
	this.Band = &band
	var duration int32 = 600
	this.Duration = &duration
	var format CaptureWirelessFormat = CAPTUREWIRELESSFORMAT_PCAP
	this.Format = &format
...
func (o *CaptureWireless) SetApMacNil() {
	o.ApMac.Set(nil)
}
...
// SetBand gets a reference to the given CaptureWirelessBand and assigns it to the Band field.
...
// SetFormat gets a reference to the given CaptureWirelessFormat and assigns it to the Format field.
...
func (o CaptureWireless) MarshalJSON() ([]byte, error) {
...
func (o CaptureWireless) ToMap() (map[string]interface{}, error) {
...
func (o *CaptureWireless) UnmarshalJSON(data []byte) (err error) {
	...
	varCaptureWireless := _CaptureWireless{}

	err = json.Unmarshal(data, &varCaptureWireless)

	if err != nil {
		return err
	}

	*o = CaptureWireless(varCaptureWireless)
...
type NullableCaptureWireless struct {
	value *CaptureWireless
	isSet bool
}

func (v NullableCaptureWireless) Get() *CaptureWireless {
	return v.value
}

func (v *NullableCaptureWireless) Set(val *CaptureWireless) {
	v.value = val
	v.isSet = true
}

func (v NullableCaptureWireless) IsSet() bool {
	return v.isSet
}

func (v *NullableCaptureWireless) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCaptureWireless(val *CaptureWireless) *NullableCaptureWireless {
	return &NullableCaptureWireless{value: val, isSet: true}
}

func (v NullableCaptureWireless) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCaptureWireless) UnmarshalJSON(src []byte) error {
	v.isSet = true
