...
*/
func (a *AdminsLogoutAPIService) Logout(ctx context.Context) ApiLogoutRequest {
	return ApiLogoutRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AdminsLogoutAPIService) LogoutExecute(r ApiLogoutRequest) (*ResponseLogout, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ResponseLogout
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdminsLogoutAPIService.Logout")
	if err != nil {
