...
func (r ApiListDeviceModelsRequest) Execute() ([]ConstDeviceModel, *http.Response, error) {
	return r.ApiService.ListDeviceModelsExecute(r)
}
...
Get list of AP device models for the Mist Site
 ...
 @return ApiListDeviceModelsRequest
*/
func (a *ConstantsModelsAPIService) ListDeviceModels(ctx context.Context) ApiListDeviceModelsRequest {
	return ApiListDeviceModelsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return []ConstDeviceModel
func (a *ConstantsModelsAPIService) ListDeviceModelsExecute(r ApiListDeviceModelsRequest) ([]ConstDeviceModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []ConstDeviceModel
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConstantsModelsAPIService.ListDeviceModels")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/const/device_models"
...
func (r ApiListMxEdgeModelsRequest) Execute() ([]ConstMxedgeModel, *http.Response, error) {
	return r.ApiService.ListMxEdgeModelsExecute(r)
}
...
Get List of available Mx Edge models
 ...
 @return ApiListMxEdgeModelsRequest
*/
func (a *ConstantsModelsAPIService) ListMxEdgeModels(ctx context.Context) ApiListMxEdgeModelsRequest {
	return ApiListMxEdgeModelsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []ConstMxedgeModel
func (a *ConstantsModelsAPIService) ListMxEdgeModelsExecute(r ApiListMxEdgeModelsRequest) ([]ConstMxedgeModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []ConstMxedgeModel
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConstantsModelsAPIService.ListMxEdgeModels")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/const/mxedge_models"
...
func (r ApiListSupportedOtherDeviceModelsRequest) Execute() ([]ConstOtherDeviceModel, *http.Response, error) {
	return r.ApiService.ListSupportedOtherDeviceModelsExecute(r)
}
...
Supported OtherDevice Models
 ...
 @return ApiListSupportedOtherDeviceModelsRequest
*/
func (a *ConstantsModelsAPIService) ListSupportedOtherDeviceModels(ctx context.Context) ApiListSupportedOtherDeviceModelsRequest {
	return ApiListSupportedOtherDeviceModelsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []ConstOtherDeviceModel
func (a *ConstantsModelsAPIService) ListSupportedOtherDeviceModelsExecute(r ApiListSupportedOtherDeviceModelsRequest) ([]ConstOtherDeviceModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []ConstOtherDeviceModel
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConstantsModelsAPIService.ListSupportedOtherDeviceModels")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/const/otherdevice_models"
