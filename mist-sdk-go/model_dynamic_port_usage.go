...
type DynamicPortUsage struct {
	...
	ResetDefaultWhen *DynamicPortUsageResetDefaultWhen `json:"reset_default_when,omitempty"`
...
func NewDynamicPortUsage(mode IpConfigType) *DynamicPortUsage {
	...
	this.Mode = mode
	var resetDefaultWhen DynamicPortUsageResetDefaultWhen = DYNAMICPORTUSAGERESETDEFAULTWHEN_LINK_DOWN
...
func (o *DynamicPortUsage) GetResetDefaultWhen() DynamicPortUsageResetDefaultWhen {
	if o == nil || IsNil(o.ResetDefaultWhen) {
		var ret DynamicPortUsageResetDefaultWhen
		return ret
	}
...
// SetResetDefaultWhen gets a reference to the given DynamicPortUsageResetDefaultWhen and assigns it to the ResetDefaultWhen field.
