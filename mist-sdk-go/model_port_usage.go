...
// checks if the PortUsage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PortUsage{}

// PortUsage Junos port usages
type PortUsage struct {
	...
	Duplex *PortUsageDuplex `json:"duplex,omitempty"`
	...
	MacAuthProtocol *PortUsageMacAuthProtocol `json:"mac_auth_protocol,omitempty"`
	...
	Mode *PortUsageMode `json:"mode,omitempty"`
	...
	StormControl *PortUsageStormControl `json:"storm_control,omitempty"`
...
func NewPortUsage() *PortUsage {
	...
	var duplex PortUsageDuplex = PORTUSAGEDUPLEX_AUTO
	this.Duplex = &duplex
	...
	var macAuthProtocol PortUsageMacAuthProtocol = PORTUSAGEMACAUTHPROTOCOL_EAP_MD5
...
// SetDuplex gets a reference to the given PortUsageDuplex and assigns it to the Duplex field.
...
func (o *PortUsage) SetGuestNetworkNil() {
...
func (o *PortUsage) GetMacAuthProtocol() PortUsageMacAuthProtocol {
	if o == nil || IsNil(o.MacAuthProtocol) {
		var ret PortUsageMacAuthProtocol
		return ret
	}
...
// SetMacAuthProtocol gets a reference to the given PortUsageMacAuthProtocol and assigns it to the MacAuthProtocol field.
...
// SetMode gets a reference to the given PortUsageMode and assigns it to the Mode field.
...
func (o *PortUsage) SetRejectedNetworkNil() {
...
// SetStormControl gets a reference to the given PortUsageStormControl and assigns it to the StormControl field.
...
func (o PortUsage) MarshalJSON() ([]byte, error) {
...
func (o PortUsage) ToMap() (map[string]interface{}, error) {
...
func (o *PortUsage) UnmarshalJSON(data []byte) (err error) {
	varPortUsage := _PortUsage{}

	err = json.Unmarshal(data, &varPortUsage)

	if err != nil {
		return err
	}

	*o = PortUsage(varPortUsage)
...
type NullablePortUsage struct {
	value *PortUsage
	isSet bool
}

func (v NullablePortUsage) Get() *PortUsage {
	return v.value
}

func (v *NullablePortUsage) Set(val *PortUsage) {
	v.value = val
	v.isSet = true
}

func (v NullablePortUsage) IsSet() bool {
	return v.isSet
}

func (v *NullablePortUsage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePortUsage(val *PortUsage) *NullablePortUsage {
	return &NullablePortUsage{value: val, isSet: true}
}

func (v NullablePortUsage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePortUsage) UnmarshalJSON(src []byte) error {
	v.isSet = true
