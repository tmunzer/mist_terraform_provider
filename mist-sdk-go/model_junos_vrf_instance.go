...
// checks if the JunosVrfInstance type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JunosVrfInstance{}

// JunosVrfInstance struct for JunosVrfInstance
type JunosVrfInstance struct {
...
type _JunosVrfInstance JunosVrfInstance
...
func (o JunosVrfInstance) MarshalJSON() ([]byte, error) {
...
func (o JunosVrfInstance) ToMap() (map[string]interface{}, error) {
...
func (o *JunosVrfInstance) UnmarshalJSON(data []byte) (err error) {
	varJunosVrfInstance := _JunosVrfInstance{}

	err = json.Unmarshal(data, &varJunosVrfInstance)

	if err != nil {
		return err
	}

	*o = JunosVrfInstance(varJunosVrfInstance)
...
type NullableJunosVrfInstance struct {
	value *JunosVrfInstance
	isSet bool
}

func (v NullableJunosVrfInstance) Get() *JunosVrfInstance {
	return v.value
}

func (v *NullableJunosVrfInstance) Set(val *JunosVrfInstance) {
	v.value = val
	v.isSet = true
}

func (v NullableJunosVrfInstance) IsSet() bool {
	return v.isSet
}

func (v *NullableJunosVrfInstance) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJunosVrfInstance(val *JunosVrfInstance) *NullableJunosVrfInstance {
	return &NullableJunosVrfInstance{value: val, isSet: true}
}

func (v NullableJunosVrfInstance) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJunosVrfInstance) UnmarshalJSON(src []byte) error {
	v.isSet = true
