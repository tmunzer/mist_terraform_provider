...
// checks if the ResponseEventsPathSearch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseEventsPathSearch{}

// ResponseEventsPathSearch struct for ResponseEventsPathSearch
...
type _ResponseEventsPathSearch ResponseEventsPathSearch
...
// SetResults gets a reference to the given []ServicePathEvent and assigns it to the Results field.
...
func (o ResponseEventsPathSearch) MarshalJSON() ([]byte, error) {
...
func (o ResponseEventsPathSearch) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseEventsPathSearch) UnmarshalJSON(data []byte) (err error) {
	varResponseEventsPathSearch := _ResponseEventsPathSearch{}

	err = json.Unmarshal(data, &varResponseEventsPathSearch)

	if err != nil {
		return err
	}

	*o = ResponseEventsPathSearch(varResponseEventsPathSearch)
...
type NullableResponseEventsPathSearch struct {
	value *ResponseEventsPathSearch
	isSet bool
}

func (v NullableResponseEventsPathSearch) Get() *ResponseEventsPathSearch {
	return v.value
}

func (v *NullableResponseEventsPathSearch) Set(val *ResponseEventsPathSearch) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseEventsPathSearch) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseEventsPathSearch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseEventsPathSearch(val *ResponseEventsPathSearch) *NullableResponseEventsPathSearch {
	return &NullableResponseEventsPathSearch{value: val, isSet: true}
}

func (v NullableResponseEventsPathSearch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseEventsPathSearch) UnmarshalJSON(src []byte) error {
	v.isSet = true
