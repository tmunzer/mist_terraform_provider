...
// checks if the OrgLicenseAction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrgLicenseAction{}

// OrgLicenseAction struct for OrgLicenseAction
type OrgLicenseAction struct {
	...
	Op OrgLicenseActionOperation `json:"op"`
...
type _OrgLicenseAction OrgLicenseAction
...
func (o *OrgLicenseAction) GetOp() OrgLicenseActionOperation {
	if o == nil {
		var ret OrgLicenseActionOperation
		return ret
	}
...
func (o OrgLicenseAction) ToMap() (map[string]interface{}, error) {
...
func (o *OrgLicenseAction) UnmarshalJSON(data []byte) (err error) {
	...
	varOrgLicenseAction := _OrgLicenseAction{}

	err = json.Unmarshal(data, &varOrgLicenseAction)

	if err != nil {
		return err
	}

	*o = OrgLicenseAction(varOrgLicenseAction)
...
type NullableOrgLicenseAction struct {
	value *OrgLicenseAction
	isSet bool
}

func (v NullableOrgLicenseAction) Get() *OrgLicenseAction {
	return v.value
}

func (v *NullableOrgLicenseAction) Set(val *OrgLicenseAction) {
	v.value = val
	v.isSet = true
}

func (v NullableOrgLicenseAction) IsSet() bool {
	return v.isSet
}

func (v *NullableOrgLicenseAction) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrgLicenseAction(val *OrgLicenseAction) *NullableOrgLicenseAction {
	return &NullableOrgLicenseAction{value: val, isSet: true}
}

func (v NullableOrgLicenseAction) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrgLicenseAction) UnmarshalJSON(src []byte) error {
	v.isSet = true
