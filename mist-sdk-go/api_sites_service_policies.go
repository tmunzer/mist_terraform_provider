...
func (r ApiListSiteServicePoliciesDerivedRequest) Resolve(resolve bool) ApiListSiteServicePoliciesDerivedRequest {
	r.resolve = &resolve
	return r
}

func (r ApiListSiteServicePoliciesDerivedRequest) Execute() ([]ServicePolicy, *http.Response, error) {
	return r.ApiService.ListSiteServicePoliciesDerivedExecute(r)
}
...
Retrieves the list of Service Policies available for the Site
 ...
 @return ApiListSiteServicePoliciesDerivedRequest
*/
func (a *SitesServicePoliciesAPIService) ListSiteServicePoliciesDerived(ctx context.Context, siteId string) ApiListSiteServicePoliciesDerivedRequest {
	return ApiListSiteServicePoliciesDerivedRequest{
		ApiService: a,
		ctx: ctx,
		siteId: siteId,
...
//  @return []ServicePolicy
func (a *SitesServicePoliciesAPIService) ListSiteServicePoliciesDerivedExecute(r ApiListSiteServicePoliciesDerivedRequest) ([]ServicePolicy, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SitesServicePoliciesAPIService.ListSiteServicePoliciesDerived")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/sites/{site_id}/servicepolicies/derived"
