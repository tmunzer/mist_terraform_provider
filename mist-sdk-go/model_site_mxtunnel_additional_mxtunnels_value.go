...
// checks if the SiteMxtunnelAdditionalMxtunnelsValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SiteMxtunnelAdditionalMxtunnelsValue{}

// SiteMxtunnelAdditionalMxtunnelsValue struct for SiteMxtunnelAdditionalMxtunnelsValue
type SiteMxtunnelAdditionalMxtunnelsValue struct {
...
type _SiteMxtunnelAdditionalMxtunnelsValue SiteMxtunnelAdditionalMxtunnelsValue
...
func NewSiteMxtunnelAdditionalMxtunnelsValue() *SiteMxtunnelAdditionalMxtunnelsValue {
	this := SiteMxtunnelAdditionalMxtunnelsValue{}
...
func (o SiteMxtunnelAdditionalMxtunnelsValue) MarshalJSON() ([]byte, error) {
...
func (o SiteMxtunnelAdditionalMxtunnelsValue) ToMap() (map[string]interface{}, error) {
...
func (o *SiteMxtunnelAdditionalMxtunnelsValue) UnmarshalJSON(data []byte) (err error) {
	varSiteMxtunnelAdditionalMxtunnelsValue := _SiteMxtunnelAdditionalMxtunnelsValue{}

	err = json.Unmarshal(data, &varSiteMxtunnelAdditionalMxtunnelsValue)

	if err != nil {
		return err
	}

	*o = SiteMxtunnelAdditionalMxtunnelsValue(varSiteMxtunnelAdditionalMxtunnelsValue)
...
type NullableSiteMxtunnelAdditionalMxtunnelsValue struct {
	value *SiteMxtunnelAdditionalMxtunnelsValue
	isSet bool
}

func (v NullableSiteMxtunnelAdditionalMxtunnelsValue) Get() *SiteMxtunnelAdditionalMxtunnelsValue {
	return v.value
}

func (v *NullableSiteMxtunnelAdditionalMxtunnelsValue) Set(val *SiteMxtunnelAdditionalMxtunnelsValue) {
	v.value = val
	v.isSet = true
}

func (v NullableSiteMxtunnelAdditionalMxtunnelsValue) IsSet() bool {
	return v.isSet
}

func (v *NullableSiteMxtunnelAdditionalMxtunnelsValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSiteMxtunnelAdditionalMxtunnelsValue(val *SiteMxtunnelAdditionalMxtunnelsValue) *NullableSiteMxtunnelAdditionalMxtunnelsValue {
	return &NullableSiteMxtunnelAdditionalMxtunnelsValue{value: val, isSet: true}
}

func (v NullableSiteMxtunnelAdditionalMxtunnelsValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSiteMxtunnelAdditionalMxtunnelsValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
