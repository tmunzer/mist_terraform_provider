...
// checks if the GatewayTemplateTunnelProviderZscaler type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewayTemplateTunnelProviderZscaler{}

// GatewayTemplateTunnelProviderZscaler for zscaler-ipsec and zscaler-gre
type GatewayTemplateTunnelProviderZscaler struct {
	...
	// if `use_xff`==`true`
	SubLocations []GatewayTemplateTunnelProviderZscalerSubLocationsInner `json:"sub_locations,omitempty"`
	// the download bandwidth cap of the link, in Mbps
...
type _GatewayTemplateTunnelProviderZscaler GatewayTemplateTunnelProviderZscaler
...
func NewGatewayTemplateTunnelProviderZscaler() *GatewayTemplateTunnelProviderZscaler {
	this := GatewayTemplateTunnelProviderZscaler{}
...
func (o *GatewayTemplateTunnelProviderZscaler) GetSubLocations() []GatewayTemplateTunnelProviderZscalerSubLocationsInner {
	if o == nil || IsNil(o.SubLocations) {
		var ret []GatewayTemplateTunnelProviderZscalerSubLocationsInner
		return ret
	}
...
// SetSubLocations gets a reference to the given []GatewayTemplateTunnelProviderZscalerSubLocationsInner and assigns it to the SubLocations field.
...
func (o GatewayTemplateTunnelProviderZscaler) MarshalJSON() ([]byte, error) {
...
func (o GatewayTemplateTunnelProviderZscaler) ToMap() (map[string]interface{}, error) {
...
func (o *GatewayTemplateTunnelProviderZscaler) UnmarshalJSON(data []byte) (err error) {
	varGatewayTemplateTunnelProviderZscaler := _GatewayTemplateTunnelProviderZscaler{}

	err = json.Unmarshal(data, &varGatewayTemplateTunnelProviderZscaler)

	if err != nil {
		return err
	}

	*o = GatewayTemplateTunnelProviderZscaler(varGatewayTemplateTunnelProviderZscaler)
...
type NullableGatewayTemplateTunnelProviderZscaler struct {
	value *GatewayTemplateTunnelProviderZscaler
	isSet bool
}

func (v NullableGatewayTemplateTunnelProviderZscaler) Get() *GatewayTemplateTunnelProviderZscaler {
	return v.value
}

func (v *NullableGatewayTemplateTunnelProviderZscaler) Set(val *GatewayTemplateTunnelProviderZscaler) {
	v.value = val
	v.isSet = true
}

func (v NullableGatewayTemplateTunnelProviderZscaler) IsSet() bool {
	return v.isSet
}

func (v *NullableGatewayTemplateTunnelProviderZscaler) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGatewayTemplateTunnelProviderZscaler(val *GatewayTemplateTunnelProviderZscaler) *NullableGatewayTemplateTunnelProviderZscaler {
	return &NullableGatewayTemplateTunnelProviderZscaler{value: val, isSet: true}
}

func (v NullableGatewayTemplateTunnelProviderZscaler) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGatewayTemplateTunnelProviderZscaler) UnmarshalJSON(src []byte) error {
	v.isSet = true
