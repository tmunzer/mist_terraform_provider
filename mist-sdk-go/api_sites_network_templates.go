...
func (r ApiGetSiteNetworkTemplateDerivedRequest) Resolve(resolve bool) ApiGetSiteNetworkTemplateDerivedRequest {
	r.resolve = &resolve
	return r
}

func (r ApiGetSiteNetworkTemplateDerivedRequest) Execute() (*NetworkTemplate, *http.Response, error) {
	return r.ApiService.GetSiteNetworkTemplateDerivedExecute(r)
}
...
Get derived Network Templates for Site
 ...
 @return ApiGetSiteNetworkTemplateDerivedRequest
*/
func (a *SitesNetworkTemplatesAPIService) GetSiteNetworkTemplateDerived(ctx context.Context, siteId string) ApiGetSiteNetworkTemplateDerivedRequest {
	return ApiGetSiteNetworkTemplateDerivedRequest{
		ApiService: a,
		ctx: ctx,
		siteId: siteId,
...
//  @return NetworkTemplate
func (a *SitesNetworkTemplatesAPIService) GetSiteNetworkTemplateDerivedExecute(r ApiGetSiteNetworkTemplateDerivedRequest) (*NetworkTemplate, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SitesNetworkTemplatesAPIService.GetSiteNetworkTemplateDerived")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/sites/{site_id}/networktemplates/derived"
