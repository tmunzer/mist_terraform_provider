...
func (r ApiGetSiteJseInfoRequest) Execute() (*AccountJseInfo, *http.Response, error) {
	return r.ApiService.GetSiteJseInfoExecute(r)
}
...
Retrieves the list of JSE orgs associated with the account
 ...
 @return ApiGetSiteJseInfoRequest
*/
func (a *SitesJSEAPIService) GetSiteJseInfo(ctx context.Context, siteId string) ApiGetSiteJseInfoRequest {
	return ApiGetSiteJseInfoRequest{
		ApiService: a,
		ctx: ctx,
		siteId: siteId,
...
//  @return AccountJseInfo
func (a *SitesJSEAPIService) GetSiteJseInfoExecute(r ApiGetSiteJseInfoRequest) (*AccountJseInfo, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SitesJSEAPIService.GetSiteJseInfo")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/sites/{site_id}/setting/jse/info"
