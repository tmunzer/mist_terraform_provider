...
func (r ApiGetSiteGatewayTemplateDerivedRequest) Resolve(resolve bool) ApiGetSiteGatewayTemplateDerivedRequest {
	r.resolve = &resolve
	return r
}

func (r ApiGetSiteGatewayTemplateDerivedRequest) Execute() (*GatewayTemplate, *http.Response, error) {
	return r.ApiService.GetSiteGatewayTemplateDerivedExecute(r)
}
...
Get derived Gateway Templates for Site
 ...
 @return ApiGetSiteGatewayTemplateDerivedRequest
*/
func (a *SitesGatewayTemplatesAPIService) GetSiteGatewayTemplateDerived(ctx context.Context, siteId string) ApiGetSiteGatewayTemplateDerivedRequest {
	return ApiGetSiteGatewayTemplateDerivedRequest{
		ApiService: a,
		ctx: ctx,
		siteId: siteId,
...
//  @return GatewayTemplate
func (a *SitesGatewayTemplatesAPIService) GetSiteGatewayTemplateDerivedExecute(r ApiGetSiteGatewayTemplateDerivedRequest) (*GatewayTemplate, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SitesGatewayTemplatesAPIService.GetSiteGatewayTemplateDerived")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/sites/{site_id}/gatewaytemplates/derived"
