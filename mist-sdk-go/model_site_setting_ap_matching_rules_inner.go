...
// checks if the SiteSettingApMatchingRulesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SiteSettingApMatchingRulesInner{}

// SiteSettingApMatchingRulesInner struct for SiteSettingApMatchingRulesInner
type SiteSettingApMatchingRulesInner struct {
...
type _SiteSettingApMatchingRulesInner SiteSettingApMatchingRulesInner
...
func NewSiteSettingApMatchingRulesInner() *SiteSettingApMatchingRulesInner {
	this := SiteSettingApMatchingRulesInner{}
	return &this
}
...
func (o SiteSettingApMatchingRulesInner) MarshalJSON() ([]byte, error) {
...
func (o SiteSettingApMatchingRulesInner) ToMap() (map[string]interface{}, error) {
...
func (o *SiteSettingApMatchingRulesInner) UnmarshalJSON(data []byte) (err error) {
	varSiteSettingApMatchingRulesInner := _SiteSettingApMatchingRulesInner{}

	err = json.Unmarshal(data, &varSiteSettingApMatchingRulesInner)

	if err != nil {
		return err
	}

	*o = SiteSettingApMatchingRulesInner(varSiteSettingApMatchingRulesInner)
...
type NullableSiteSettingApMatchingRulesInner struct {
	value *SiteSettingApMatchingRulesInner
	isSet bool
}

func (v NullableSiteSettingApMatchingRulesInner) Get() *SiteSettingApMatchingRulesInner {
	return v.value
}

func (v *NullableSiteSettingApMatchingRulesInner) Set(val *SiteSettingApMatchingRulesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSiteSettingApMatchingRulesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSiteSettingApMatchingRulesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSiteSettingApMatchingRulesInner(val *SiteSettingApMatchingRulesInner) *NullableSiteSettingApMatchingRulesInner {
	return &NullableSiteSettingApMatchingRulesInner{value: val, isSet: true}
}

func (v NullableSiteSettingApMatchingRulesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSiteSettingApMatchingRulesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
