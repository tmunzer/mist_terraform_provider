...
// checks if the SleSummaryImpact type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SleSummaryImpact{}

// SleSummaryImpact struct for SleSummaryImpact
...
type _SleSummaryImpact SleSummaryImpact
...
func (o SleSummaryImpact) MarshalJSON() ([]byte, error) {
...
func (o SleSummaryImpact) ToMap() (map[string]interface{}, error) {
...
func (o *SleSummaryImpact) UnmarshalJSON(data []byte) (err error) {
	...
	varSleSummaryImpact := _SleSummaryImpact{}

	err = json.Unmarshal(data, &varSleSummaryImpact)

	if err != nil {
		return err
	}

	*o = SleSummaryImpact(varSleSummaryImpact)
...
type NullableSleSummaryImpact struct {
	value *SleSummaryImpact
	isSet bool
}

func (v NullableSleSummaryImpact) Get() *SleSummaryImpact {
	return v.value
}

func (v *NullableSleSummaryImpact) Set(val *SleSummaryImpact) {
	v.value = val
	v.isSet = true
}

func (v NullableSleSummaryImpact) IsSet() bool {
	return v.isSet
}

func (v *NullableSleSummaryImpact) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSleSummaryImpact(val *SleSummaryImpact) *NullableSleSummaryImpact {
	return &NullableSleSummaryImpact{value: val, isSet: true}
}

func (v NullableSleSummaryImpact) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSleSummaryImpact) UnmarshalJSON(src []byte) error {
	v.isSet = true
