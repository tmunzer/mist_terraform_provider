...
// checks if the SleImpactedGateways type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SleImpactedGateways{}

// SleImpactedGateways struct for SleImpactedGateways
...
type _SleImpactedGateways SleImpactedGateways
...
func (o *SleImpactedGateways) GetGateways() []SleImpactedGatewaysGateway {
	if o == nil || IsNil(o.Gateways) {
		var ret []SleImpactedGatewaysGateway
		return ret
	}
	return o.Gateways
}
...
// SetGateways gets a reference to the given []SleImpactedGatewaysGateway and assigns it to the Gateways field.
...
func (o SleImpactedGateways) MarshalJSON() ([]byte, error) {
...
func (o SleImpactedGateways) ToMap() (map[string]interface{}, error) {
...
func (o *SleImpactedGateways) UnmarshalJSON(data []byte) (err error) {
	varSleImpactedGateways := _SleImpactedGateways{}

	err = json.Unmarshal(data, &varSleImpactedGateways)

	if err != nil {
		return err
	}

	*o = SleImpactedGateways(varSleImpactedGateways)
...
type NullableSleImpactedGateways struct {
	value *SleImpactedGateways
	isSet bool
}

func (v NullableSleImpactedGateways) Get() *SleImpactedGateways {
	return v.value
}

func (v *NullableSleImpactedGateways) Set(val *SleImpactedGateways) {
	v.value = val
	v.isSet = true
}

func (v NullableSleImpactedGateways) IsSet() bool {
	return v.isSet
}

func (v *NullableSleImpactedGateways) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSleImpactedGateways(val *SleImpactedGateways) *NullableSleImpactedGateways {
	return &NullableSleImpactedGateways{value: val, isSet: true}
}

func (v NullableSleImpactedGateways) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSleImpactedGateways) UnmarshalJSON(src []byte) error {
	v.isSet = true
