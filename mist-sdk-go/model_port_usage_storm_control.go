...
// checks if the PortUsageStormControl type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PortUsageStormControl{}

// PortUsageStormControl Switch storm control
type PortUsageStormControl struct {
...
type _PortUsageStormControl PortUsageStormControl
...
func (o PortUsageStormControl) MarshalJSON() ([]byte, error) {
...
func (o PortUsageStormControl) ToMap() (map[string]interface{}, error) {
...
func (o *PortUsageStormControl) UnmarshalJSON(data []byte) (err error) {
	varPortUsageStormControl := _PortUsageStormControl{}

	err = json.Unmarshal(data, &varPortUsageStormControl)

	if err != nil {
		return err
	}

	*o = PortUsageStormControl(varPortUsageStormControl)
...
type NullablePortUsageStormControl struct {
	value *PortUsageStormControl
	isSet bool
}

func (v NullablePortUsageStormControl) Get() *PortUsageStormControl {
	return v.value
}

func (v *NullablePortUsageStormControl) Set(val *PortUsageStormControl) {
	v.value = val
	v.isSet = true
}

func (v NullablePortUsageStormControl) IsSet() bool {
	return v.isSet
}

func (v *NullablePortUsageStormControl) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePortUsageStormControl(val *PortUsageStormControl) *NullablePortUsageStormControl {
	return &NullablePortUsageStormControl{value: val, isSet: true}
}

func (v NullablePortUsageStormControl) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePortUsageStormControl) UnmarshalJSON(src []byte) error {
	v.isSet = true
