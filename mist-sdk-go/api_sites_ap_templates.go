...
func (r ApiGetSiteApTemplateDerivedRequest) Resolve(resolve bool) ApiGetSiteApTemplateDerivedRequest {
	r.resolve = &resolve
	return r
}

func (r ApiGetSiteApTemplateDerivedRequest) Execute() (*ApTemplate, *http.Response, error) {
	return r.ApiService.GetSiteApTemplateDerivedExecute(r)
}
...
Get derived AP Templates for Site
 ...
 @return ApiGetSiteApTemplateDerivedRequest
*/
func (a *SitesAPTemplatesAPIService) GetSiteApTemplateDerived(ctx context.Context, siteId string) ApiGetSiteApTemplateDerivedRequest {
	return ApiGetSiteApTemplateDerivedRequest{
		ApiService: a,
		ctx: ctx,
		siteId: siteId,
...
//  @return ApTemplate
func (a *SitesAPTemplatesAPIService) GetSiteApTemplateDerivedExecute(r ApiGetSiteApTemplateDerivedRequest) (*ApTemplate, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SitesAPTemplatesAPIService.GetSiteApTemplateDerived")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/sites/{site_id}/aptemplates/derived"
