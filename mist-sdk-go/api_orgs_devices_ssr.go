...
func (r ApiGetOrg128TRegistrationCommandsRequest) Execute() (*ReponseRouter128tRegisterCmd, *http.Response, error) {
	return r.ApiService.GetOrg128TRegistrationCommandsExecute(r)
}
...
128T devices can be managed/adopted by Mist.
 ...
 @return ApiGetOrg128TRegistrationCommandsRequest
*/
func (a *OrgsDevicesSSRAPIService) GetOrg128TRegistrationCommands(ctx context.Context, orgId string) ApiGetOrg128TRegistrationCommandsRequest {
	return ApiGetOrg128TRegistrationCommandsRequest{
		ApiService: a,
		ctx: ctx,
		orgId: orgId,
...
//  @return ReponseRouter128tRegisterCmd
func (a *OrgsDevicesSSRAPIService) GetOrg128TRegistrationCommandsExecute(r ApiGetOrg128TRegistrationCommandsRequest) (*ReponseRouter128tRegisterCmd, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ReponseRouter128tRegisterCmd
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrgsDevicesSSRAPIService.GetOrg128TRegistrationCommands")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/orgs/{org_id}/128routers/register_cmd"
