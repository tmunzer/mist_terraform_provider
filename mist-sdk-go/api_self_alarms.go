...
func (r ApiListAlarmSubscriptionsRequest) Execute() ([]ResponseSelfSubscription, *http.Response, error) {
	return r.ApiService.ListAlarmSubscriptionsExecute(r)
}
...
Get List of all the subscriptions
 ...
 @return ApiListAlarmSubscriptionsRequest
*/
func (a *SelfAlarmsAPIService) ListAlarmSubscriptions(ctx context.Context) ApiListAlarmSubscriptionsRequest {
	return ApiListAlarmSubscriptionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return []ResponseSelfSubscription
func (a *SelfAlarmsAPIService) ListAlarmSubscriptionsExecute(r ApiListAlarmSubscriptionsRequest) ([]ResponseSelfSubscription, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []ResponseSelfSubscription
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SelfAlarmsAPIService.ListAlarmSubscriptions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/self/subscriptions"
