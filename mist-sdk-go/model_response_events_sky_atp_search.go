...
// checks if the ResponseEventsSkyAtpSearch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseEventsSkyAtpSearch{}

// ResponseEventsSkyAtpSearch struct for ResponseEventsSkyAtpSearch
...
type _ResponseEventsSkyAtpSearch ResponseEventsSkyAtpSearch
...
func NewResponseEventsSkyAtpSearch(end int32, limit int32, results []EventsSkyatp, start int32, total int32) *ResponseEventsSkyAtpSearch {
	this := ResponseEventsSkyAtpSearch{}
	this.End = end
	this.Limit = limit
...
func (o ResponseEventsSkyAtpSearch) MarshalJSON() ([]byte, error) {
...
func (o ResponseEventsSkyAtpSearch) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseEventsSkyAtpSearch) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseEventsSkyAtpSearch := _ResponseEventsSkyAtpSearch{}

	err = json.Unmarshal(data, &varResponseEventsSkyAtpSearch)

	if err != nil {
		return err
	}

	*o = ResponseEventsSkyAtpSearch(varResponseEventsSkyAtpSearch)
...
type NullableResponseEventsSkyAtpSearch struct {
	value *ResponseEventsSkyAtpSearch
	isSet bool
}

func (v NullableResponseEventsSkyAtpSearch) Get() *ResponseEventsSkyAtpSearch {
	return v.value
}

func (v *NullableResponseEventsSkyAtpSearch) Set(val *ResponseEventsSkyAtpSearch) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseEventsSkyAtpSearch) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseEventsSkyAtpSearch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseEventsSkyAtpSearch(val *ResponseEventsSkyAtpSearch) *NullableResponseEventsSkyAtpSearch {
	return &NullableResponseEventsSkyAtpSearch{value: val, isSet: true}
}

func (v NullableResponseEventsSkyAtpSearch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseEventsSkyAtpSearch) UnmarshalJSON(src []byte) error {
	v.isSet = true
