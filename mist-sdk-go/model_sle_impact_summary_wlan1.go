...
// checks if the SleImpactSummaryWlan1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SleImpactSummaryWlan1{}

// SleImpactSummaryWlan1 struct for SleImpactSummaryWlan1
type SleImpactSummaryWlan1 struct {
...
type _SleImpactSummaryWlan1 SleImpactSummaryWlan1
...
func (o SleImpactSummaryWlan1) MarshalJSON() ([]byte, error) {
...
func (o SleImpactSummaryWlan1) ToMap() (map[string]interface{}, error) {
...
func (o *SleImpactSummaryWlan1) UnmarshalJSON(data []byte) (err error) {
	...
	varSleImpactSummaryWlan1 := _SleImpactSummaryWlan1{}

	err = json.Unmarshal(data, &varSleImpactSummaryWlan1)

	if err != nil {
		return err
	}

	*o = SleImpactSummaryWlan1(varSleImpactSummaryWlan1)
...
type NullableSleImpactSummaryWlan1 struct {
	value *SleImpactSummaryWlan1
	isSet bool
}

func (v NullableSleImpactSummaryWlan1) Get() *SleImpactSummaryWlan1 {
	return v.value
}

func (v *NullableSleImpactSummaryWlan1) Set(val *SleImpactSummaryWlan1) {
	v.value = val
	v.isSet = true
}

func (v NullableSleImpactSummaryWlan1) IsSet() bool {
	return v.isSet
}

func (v *NullableSleImpactSummaryWlan1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSleImpactSummaryWlan1(val *SleImpactSummaryWlan1) *NullableSleImpactSummaryWlan1 {
	return &NullableSleImpactSummaryWlan1{value: val, isSet: true}
}

func (v NullableSleImpactSummaryWlan1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSleImpactSummaryWlan1) UnmarshalJSON(src []byte) error {
	v.isSet = true
