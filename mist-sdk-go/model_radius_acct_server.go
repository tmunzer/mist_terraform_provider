...
// checks if the RadiusAcctServer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RadiusAcctServer{}

// RadiusAcctServer struct for RadiusAcctServer
...
type _RadiusAcctServer RadiusAcctServer
...
func (o RadiusAcctServer) MarshalJSON() ([]byte, error) {
...
func (o RadiusAcctServer) ToMap() (map[string]interface{}, error) {
...
func (o *RadiusAcctServer) UnmarshalJSON(data []byte) (err error) {
	...
	varRadiusAcctServer := _RadiusAcctServer{}

	err = json.Unmarshal(data, &varRadiusAcctServer)

	if err != nil {
		return err
	}

	*o = RadiusAcctServer(varRadiusAcctServer)
...
type NullableRadiusAcctServer struct {
	value *RadiusAcctServer
	isSet bool
}

func (v NullableRadiusAcctServer) Get() *RadiusAcctServer {
	return v.value
}

func (v *NullableRadiusAcctServer) Set(val *RadiusAcctServer) {
	v.value = val
	v.isSet = true
}

func (v NullableRadiusAcctServer) IsSet() bool {
	return v.isSet
}

func (v *NullableRadiusAcctServer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRadiusAcctServer(val *RadiusAcctServer) *NullableRadiusAcctServer {
	return &NullableRadiusAcctServer{value: val, isSet: true}
}

func (v NullableRadiusAcctServer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRadiusAcctServer) UnmarshalJSON(src []byte) error {
	v.isSet = true
