...
// Request Body
func (r ApiUpdateSdkClientRequest) NameString(nameString NameString) ApiUpdateSdkClientRequest {
	r.nameString = &nameString
	return r
}

func (r ApiUpdateSdkClientRequest) Execute() (*http.Response, error) {
	return r.ApiService.UpdateSdkClientExecute(r)
}
...
Update SDK Client
 ...
 @return ApiUpdateSdkClientRequest
*/
func (a *OrgsClientsSDKAPIService) UpdateSdkClient(ctx context.Context, orgId string, sdkclientId string) ApiUpdateSdkClientRequest {
	return ApiUpdateSdkClientRequest{
		ApiService: a,
		ctx: ctx,
		orgId: orgId,
...
func (a *OrgsClientsSDKAPIService) UpdateSdkClientExecute(r ApiUpdateSdkClientRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrgsClientsSDKAPIService.UpdateSdkClient")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/orgs/{org_id}/sdkclients/{sdkclient_id}"
