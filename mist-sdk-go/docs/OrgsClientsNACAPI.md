...
func main() {
	...
	distinct := openapiclient.org_nac_client_events_count_distinct("type") // OrgNacClientEventsCountDistinct |  (optional)
...
func main() {
	orgId := "000000ab-00ab-00ab-00ab-0000000000ab" // string | 
	distinct := openapiclient.org_nac_clients_count_distinct("type") // OrgNacClientsCountDistinct | NAC Policy Rule ID, if matched (optional) (default to "type")
