...
`func (o *ConfigDevice) GetPortUsages() map[string]PortUsage`

GetPortUsages returns the PortUsages field if non-nil, zero value otherwise.

### GetPortUsagesOk

`func (o *ConfigDevice) GetPortUsagesOk() (*map[string]PortUsage, bool)`
...
`func (o *ConfigDevice) SetPortUsages(v map[string]PortUsage)`
