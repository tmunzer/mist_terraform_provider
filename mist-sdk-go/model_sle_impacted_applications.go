...
// checks if the SleImpactedApplications type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SleImpactedApplications{}

// SleImpactedApplications struct for SleImpactedApplications
...
type _SleImpactedApplications SleImpactedApplications
...
func (o *SleImpactedApplications) GetApps() []SleImpactedApplicationsApp {
	if o == nil || IsNil(o.Apps) {
		var ret []SleImpactedApplicationsApp
		return ret
	}
	return o.Apps
}
...
// SetApps gets a reference to the given []SleImpactedApplicationsApp and assigns it to the Apps field.
...
func (o SleImpactedApplications) MarshalJSON() ([]byte, error) {
...
func (o SleImpactedApplications) ToMap() (map[string]interface{}, error) {
...
func (o *SleImpactedApplications) UnmarshalJSON(data []byte) (err error) {
	varSleImpactedApplications := _SleImpactedApplications{}

	err = json.Unmarshal(data, &varSleImpactedApplications)

	if err != nil {
		return err
	}

	*o = SleImpactedApplications(varSleImpactedApplications)
...
type NullableSleImpactedApplications struct {
	value *SleImpactedApplications
	isSet bool
}

func (v NullableSleImpactedApplications) Get() *SleImpactedApplications {
	return v.value
}

func (v *NullableSleImpactedApplications) Set(val *SleImpactedApplications) {
	v.value = val
	v.isSet = true
}

func (v NullableSleImpactedApplications) IsSet() bool {
	return v.isSet
}

func (v *NullableSleImpactedApplications) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSleImpactedApplications(val *SleImpactedApplications) *NullableSleImpactedApplications {
	return &NullableSleImpactedApplications{value: val, isSet: true}
}

func (v NullableSleImpactedApplications) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSleImpactedApplications) UnmarshalJSON(src []byte) error {
	v.isSet = true
