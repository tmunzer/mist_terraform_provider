...
// checks if the SearchEventsWanClient type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchEventsWanClient{}

// SearchEventsWanClient struct for SearchEventsWanClient
...
type _SearchEventsWanClient SearchEventsWanClient
...
// SetResults gets a reference to the given EventsClientWan and assigns it to the Results field.
...
func (o SearchEventsWanClient) MarshalJSON() ([]byte, error) {
...
func (o SearchEventsWanClient) ToMap() (map[string]interface{}, error) {
...
func (o *SearchEventsWanClient) UnmarshalJSON(data []byte) (err error) {
	varSearchEventsWanClient := _SearchEventsWanClient{}

	err = json.Unmarshal(data, &varSearchEventsWanClient)

	if err != nil {
		return err
	}

	*o = SearchEventsWanClient(varSearchEventsWanClient)
...
type NullableSearchEventsWanClient struct {
	value *SearchEventsWanClient
	isSet bool
}

func (v NullableSearchEventsWanClient) Get() *SearchEventsWanClient {
	return v.value
}

func (v *NullableSearchEventsWanClient) Set(val *SearchEventsWanClient) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchEventsWanClient) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchEventsWanClient) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchEventsWanClient(val *SearchEventsWanClient) *NullableSearchEventsWanClient {
	return &NullableSearchEventsWanClient{value: val, isSet: true}
}

func (v NullableSearchEventsWanClient) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSearchEventsWanClient) UnmarshalJSON(src []byte) error {
	v.isSet = true
