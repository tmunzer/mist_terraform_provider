...
// checks if the ResponseZoneSearch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseZoneSearch{}

// ResponseZoneSearch struct for ResponseZoneSearch
...
type _ResponseZoneSearch ResponseZoneSearch
...
func (o *ResponseZoneSearch) GetResults() []ResponseZoneSearchItem {
	if o == nil || IsNil(o.Results) {
		var ret []ResponseZoneSearchItem
		return ret
	}
	return o.Results
}
...
// SetResults gets a reference to the given []ResponseZoneSearchItem and assigns it to the Results field.
...
func (o ResponseZoneSearch) MarshalJSON() ([]byte, error) {
...
func (o ResponseZoneSearch) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseZoneSearch) UnmarshalJSON(data []byte) (err error) {
	varResponseZoneSearch := _ResponseZoneSearch{}

	err = json.Unmarshal(data, &varResponseZoneSearch)

	if err != nil {
		return err
	}

	*o = ResponseZoneSearch(varResponseZoneSearch)
...
type NullableResponseZoneSearch struct {
	value *ResponseZoneSearch
	isSet bool
}

func (v NullableResponseZoneSearch) Get() *ResponseZoneSearch {
	return v.value
}

func (v *NullableResponseZoneSearch) Set(val *ResponseZoneSearch) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseZoneSearch) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseZoneSearch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseZoneSearch(val *ResponseZoneSearch) *NullableResponseZoneSearch {
	return &NullableResponseZoneSearch{value: val, isSet: true}
}

func (v NullableResponseZoneSearch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseZoneSearch) UnmarshalJSON(src []byte) error {
	v.isSet = true
