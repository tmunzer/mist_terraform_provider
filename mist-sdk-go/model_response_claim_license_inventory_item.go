...
// checks if the ResponseClaimLicenseInventoryItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseClaimLicenseInventoryItem{}

// ResponseClaimLicenseInventoryItem struct for ResponseClaimLicenseInventoryItem
...
type _ResponseClaimLicenseInventoryItem ResponseClaimLicenseInventoryItem
...
func NewResponseClaimLicenseInventoryItem(mac string, magic string, model string, serial string, type_ string) *ResponseClaimLicenseInventoryItem {
	this := ResponseClaimLicenseInventoryItem{}
	this.Mac = mac
	this.Magic = magic
	this.Model = model
	this.Serial = serial
...
func (o ResponseClaimLicenseInventoryItem) MarshalJSON() ([]byte, error) {
...
func (o ResponseClaimLicenseInventoryItem) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseClaimLicenseInventoryItem) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseClaimLicenseInventoryItem := _ResponseClaimLicenseInventoryItem{}

	err = json.Unmarshal(data, &varResponseClaimLicenseInventoryItem)

	if err != nil {
		return err
	}

	*o = ResponseClaimLicenseInventoryItem(varResponseClaimLicenseInventoryItem)
...
type NullableResponseClaimLicenseInventoryItem struct {
	value *ResponseClaimLicenseInventoryItem
	isSet bool
}

func (v NullableResponseClaimLicenseInventoryItem) Get() *ResponseClaimLicenseInventoryItem {
	return v.value
}

func (v *NullableResponseClaimLicenseInventoryItem) Set(val *ResponseClaimLicenseInventoryItem) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseClaimLicenseInventoryItem) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseClaimLicenseInventoryItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseClaimLicenseInventoryItem(val *ResponseClaimLicenseInventoryItem) *NullableResponseClaimLicenseInventoryItem {
	return &NullableResponseClaimLicenseInventoryItem{value: val, isSet: true}
}

func (v NullableResponseClaimLicenseInventoryItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseClaimLicenseInventoryItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
