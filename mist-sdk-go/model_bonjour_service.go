...
// checks if the BonjourService type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BonjourService{}

// BonjourService struct for BonjourService
...
type _BonjourService BonjourService
...
func (o BonjourService) MarshalJSON() ([]byte, error) {
...
func (o BonjourService) ToMap() (map[string]interface{}, error) {
...
func (o *BonjourService) UnmarshalJSON(data []byte) (err error) {
	varBonjourService := _BonjourService{}

	err = json.Unmarshal(data, &varBonjourService)

	if err != nil {
		return err
	}

	*o = BonjourService(varBonjourService)
...
type NullableBonjourService struct {
	value *BonjourService
	isSet bool
}

func (v NullableBonjourService) Get() *BonjourService {
	return v.value
}

func (v *NullableBonjourService) Set(val *BonjourService) {
	v.value = val
	v.isSet = true
}

func (v NullableBonjourService) IsSet() bool {
	return v.isSet
}

func (v *NullableBonjourService) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBonjourService(val *BonjourService) *NullableBonjourService {
	return &NullableBonjourService{value: val, isSet: true}
}

func (v NullableBonjourService) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBonjourService) UnmarshalJSON(src []byte) error {
	v.isSet = true
