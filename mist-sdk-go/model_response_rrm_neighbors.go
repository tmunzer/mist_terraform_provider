...
// checks if the ResponseRrmNeighbors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseRrmNeighbors{}

// ResponseRrmNeighbors struct for ResponseRrmNeighbors
...
type _ResponseRrmNeighbors ResponseRrmNeighbors
...
func (o ResponseRrmNeighbors) MarshalJSON() ([]byte, error) {
...
func (o ResponseRrmNeighbors) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseRrmNeighbors) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseRrmNeighbors := _ResponseRrmNeighbors{}

	err = json.Unmarshal(data, &varResponseRrmNeighbors)

	if err != nil {
		return err
	}

	*o = ResponseRrmNeighbors(varResponseRrmNeighbors)
...
type NullableResponseRrmNeighbors struct {
	value *ResponseRrmNeighbors
	isSet bool
}

func (v NullableResponseRrmNeighbors) Get() *ResponseRrmNeighbors {
	return v.value
}

func (v *NullableResponseRrmNeighbors) Set(val *ResponseRrmNeighbors) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseRrmNeighbors) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseRrmNeighbors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseRrmNeighbors(val *ResponseRrmNeighbors) *NullableResponseRrmNeighbors {
	return &NullableResponseRrmNeighbors{value: val, isSet: true}
}

func (v NullableResponseRrmNeighbors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseRrmNeighbors) UnmarshalJSON(src []byte) error {
	v.isSet = true
