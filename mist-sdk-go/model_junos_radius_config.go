...
// checks if the JunosRadiusConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JunosRadiusConfig{}

// JunosRadiusConfig Junos Radius config
type JunosRadiusConfig struct {
...
type _JunosRadiusConfig JunosRadiusConfig
...
func (o JunosRadiusConfig) MarshalJSON() ([]byte, error) {
...
func (o JunosRadiusConfig) ToMap() (map[string]interface{}, error) {
...
func (o *JunosRadiusConfig) UnmarshalJSON(data []byte) (err error) {
	varJunosRadiusConfig := _JunosRadiusConfig{}

	err = json.Unmarshal(data, &varJunosRadiusConfig)

	if err != nil {
		return err
	}

	*o = JunosRadiusConfig(varJunosRadiusConfig)
...
type NullableJunosRadiusConfig struct {
	value *JunosRadiusConfig
	isSet bool
}

func (v NullableJunosRadiusConfig) Get() *JunosRadiusConfig {
	return v.value
}

func (v *NullableJunosRadiusConfig) Set(val *JunosRadiusConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableJunosRadiusConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableJunosRadiusConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJunosRadiusConfig(val *JunosRadiusConfig) *NullableJunosRadiusConfig {
	return &NullableJunosRadiusConfig{value: val, isSet: true}
}

func (v NullableJunosRadiusConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJunosRadiusConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
