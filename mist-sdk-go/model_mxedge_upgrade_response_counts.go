...
// checks if the MxedgeUpgradeResponseCounts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MxedgeUpgradeResponseCounts{}

// MxedgeUpgradeResponseCounts struct for MxedgeUpgradeResponseCounts
...
type _MxedgeUpgradeResponseCounts MxedgeUpgradeResponseCounts
...
func NewMxedgeUpgradeResponseCounts(failed int32, queued int32, success int32, upgrading int32) *MxedgeUpgradeResponseCounts {
	this := MxedgeUpgradeResponseCounts{}
	this.Failed = failed
	this.Queued = queued
...
func (o MxedgeUpgradeResponseCounts) MarshalJSON() ([]byte, error) {
...
func (o MxedgeUpgradeResponseCounts) ToMap() (map[string]interface{}, error) {
...
func (o *MxedgeUpgradeResponseCounts) UnmarshalJSON(data []byte) (err error) {
	...
	varMxedgeUpgradeResponseCounts := _MxedgeUpgradeResponseCounts{}

	err = json.Unmarshal(data, &varMxedgeUpgradeResponseCounts)

	if err != nil {
		return err
	}

	*o = MxedgeUpgradeResponseCounts(varMxedgeUpgradeResponseCounts)
...
type NullableMxedgeUpgradeResponseCounts struct {
	value *MxedgeUpgradeResponseCounts
	isSet bool
}

func (v NullableMxedgeUpgradeResponseCounts) Get() *MxedgeUpgradeResponseCounts {
	return v.value
}

func (v *NullableMxedgeUpgradeResponseCounts) Set(val *MxedgeUpgradeResponseCounts) {
	v.value = val
	v.isSet = true
}

func (v NullableMxedgeUpgradeResponseCounts) IsSet() bool {
	return v.isSet
}

func (v *NullableMxedgeUpgradeResponseCounts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMxedgeUpgradeResponseCounts(val *MxedgeUpgradeResponseCounts) *NullableMxedgeUpgradeResponseCounts {
	return &NullableMxedgeUpgradeResponseCounts{value: val, isSet: true}
}

func (v NullableMxedgeUpgradeResponseCounts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMxedgeUpgradeResponseCounts) UnmarshalJSON(src []byte) error {
	v.isSet = true
