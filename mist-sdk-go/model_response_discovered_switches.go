...
// checks if the ResponseDiscoveredSwitches type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseDiscoveredSwitches{}

// ResponseDiscoveredSwitches struct for ResponseDiscoveredSwitches
...
type _ResponseDiscoveredSwitches ResponseDiscoveredSwitches
...
func NewResponseDiscoveredSwitches(end float32, limit int32, results []DiscoveredSwitch, start float32, total int32) *ResponseDiscoveredSwitches {
	this := ResponseDiscoveredSwitches{}
	this.End = end
	this.Limit = limit
...
func (o ResponseDiscoveredSwitches) MarshalJSON() ([]byte, error) {
...
func (o ResponseDiscoveredSwitches) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseDiscoveredSwitches) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseDiscoveredSwitches := _ResponseDiscoveredSwitches{}

	err = json.Unmarshal(data, &varResponseDiscoveredSwitches)

	if err != nil {
		return err
	}

	*o = ResponseDiscoveredSwitches(varResponseDiscoveredSwitches)
...
type NullableResponseDiscoveredSwitches struct {
	value *ResponseDiscoveredSwitches
	isSet bool
}

func (v NullableResponseDiscoveredSwitches) Get() *ResponseDiscoveredSwitches {
	return v.value
}

func (v *NullableResponseDiscoveredSwitches) Set(val *ResponseDiscoveredSwitches) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseDiscoveredSwitches) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseDiscoveredSwitches) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseDiscoveredSwitches(val *ResponseDiscoveredSwitches) *NullableResponseDiscoveredSwitches {
	return &NullableResponseDiscoveredSwitches{value: val, isSet: true}
}

func (v NullableResponseDiscoveredSwitches) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseDiscoveredSwitches) UnmarshalJSON(src []byte) error {
	v.isSet = true
