...
// checks if the ResponseClientSearch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseClientSearch{}

// ResponseClientSearch struct for ResponseClientSearch
...
type _ResponseClientSearch ResponseClientSearch
...
func (o ResponseClientSearch) MarshalJSON() ([]byte, error) {
...
func (o ResponseClientSearch) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseClientSearch) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseClientSearch := _ResponseClientSearch{}

	err = json.Unmarshal(data, &varResponseClientSearch)

	if err != nil {
		return err
	}

	*o = ResponseClientSearch(varResponseClientSearch)
...
type NullableResponseClientSearch struct {
	value *ResponseClientSearch
	isSet bool
}

func (v NullableResponseClientSearch) Get() *ResponseClientSearch {
	return v.value
}

func (v *NullableResponseClientSearch) Set(val *ResponseClientSearch) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseClientSearch) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseClientSearch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseClientSearch(val *ResponseClientSearch) *NullableResponseClientSearch {
	return &NullableResponseClientSearch{value: val, isSet: true}
}

func (v NullableResponseClientSearch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseClientSearch) UnmarshalJSON(src []byte) error {
	v.isSet = true
