...
// StatsDevice struct for StatsDevice
...
func (dst *StatsDevice) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(StatsDevice)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src *StatsDevice) MarshalJSON() ([]byte, error) {
	if src.ApStats != nil {
...
type NullableStatsDevice struct {
	value *StatsDevice
	isSet bool
}

func (v NullableStatsDevice) Get() *StatsDevice {
	return v.value
}

func (v *NullableStatsDevice) Set(val *StatsDevice) {
	v.value = val
	v.isSet = true
}

func (v NullableStatsDevice) IsSet() bool {
	return v.isSet
}

func (v *NullableStatsDevice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStatsDevice(val *StatsDevice) *NullableStatsDevice {
	return &NullableStatsDevice{value: val, isSet: true}
}

func (v NullableStatsDevice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStatsDevice) UnmarshalJSON(src []byte) error {
	v.isSet = true
