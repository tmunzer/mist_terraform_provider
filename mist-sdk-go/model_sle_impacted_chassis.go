...
// checks if the SleImpactedChassis type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SleImpactedChassis{}

// SleImpactedChassis struct for SleImpactedChassis
...
type _SleImpactedChassis SleImpactedChassis
...
func (o *SleImpactedChassis) GetChassis() []SleImpactedChassisChassisItem {
	if o == nil || IsNil(o.Chassis) {
		var ret []SleImpactedChassisChassisItem
		return ret
	}
	return o.Chassis
}
...
// SetChassis gets a reference to the given []SleImpactedChassisChassisItem and assigns it to the Chassis field.
...
func (o SleImpactedChassis) MarshalJSON() ([]byte, error) {
...
func (o SleImpactedChassis) ToMap() (map[string]interface{}, error) {
...
func (o *SleImpactedChassis) UnmarshalJSON(data []byte) (err error) {
	varSleImpactedChassis := _SleImpactedChassis{}

	err = json.Unmarshal(data, &varSleImpactedChassis)

	if err != nil {
		return err
	}

	*o = SleImpactedChassis(varSleImpactedChassis)
...
type NullableSleImpactedChassis struct {
	value *SleImpactedChassis
	isSet bool
}

func (v NullableSleImpactedChassis) Get() *SleImpactedChassis {
	return v.value
}

func (v *NullableSleImpactedChassis) Set(val *SleImpactedChassis) {
	v.value = val
	v.isSet = true
}

func (v NullableSleImpactedChassis) IsSet() bool {
	return v.isSet
}

func (v *NullableSleImpactedChassis) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSleImpactedChassis(val *SleImpactedChassis) *NullableSleImpactedChassis {
	return &NullableSleImpactedChassis{value: val, isSet: true}
}

func (v NullableSleImpactedChassis) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSleImpactedChassis) UnmarshalJSON(src []byte) error {
	v.isSet = true
