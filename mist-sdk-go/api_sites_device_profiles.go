...
func (r ApiListSiteDeviceProfilesDerivedRequest) Resolve(resolve bool) ApiListSiteDeviceProfilesDerivedRequest {
	r.resolve = &resolve
	return r
}

func (r ApiListSiteDeviceProfilesDerivedRequest) Execute() ([]Deviceprofile, *http.Response, error) {
	return r.ApiService.ListSiteDeviceProfilesDerivedExecute(r)
}
...
Retrieves the list of Device Profiles available for the Site
 ...
 @return ApiListSiteDeviceProfilesDerivedRequest
*/
func (a *SitesDeviceProfilesAPIService) ListSiteDeviceProfilesDerived(ctx context.Context, siteId string) ApiListSiteDeviceProfilesDerivedRequest {
	return ApiListSiteDeviceProfilesDerivedRequest{
		ApiService: a,
		ctx: ctx,
		siteId: siteId,
...
//  @return []Deviceprofile
func (a *SitesDeviceProfilesAPIService) ListSiteDeviceProfilesDerivedExecute(r ApiListSiteDeviceProfilesDerivedRequest) ([]Deviceprofile, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SitesDeviceProfilesAPIService.ListSiteDeviceProfilesDerived")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/sites/{site_id}/deviceprofiles/derived"
