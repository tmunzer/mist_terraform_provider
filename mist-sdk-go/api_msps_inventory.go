...
func (r ApiGetMspInventoryByMacRequest) Execute() (*ResponseMspInventoryDevice, *http.Response, error) {
	return r.ApiService.GetMspInventoryByMacExecute(r)
}
...
Get Inventoy By device MAC address
 ...
 @return ApiGetMspInventoryByMacRequest
*/
func (a *MSPsInventoryAPIService) GetMspInventoryByMac(ctx context.Context, mspId string, deviceMac string) ApiGetMspInventoryByMacRequest {
	return ApiGetMspInventoryByMacRequest{
		ApiService: a,
		ctx: ctx,
		mspId: mspId,
...
//  @return ResponseMspInventoryDevice
func (a *MSPsInventoryAPIService) GetMspInventoryByMacExecute(r ApiGetMspInventoryByMacRequest) (*ResponseMspInventoryDevice, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ResponseMspInventoryDevice
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MSPsInventoryAPIService.GetMspInventoryByMac")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/msps/{msp_id}/inventory/{device_mac}"
