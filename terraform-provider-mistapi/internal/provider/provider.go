...
var _ provider.Provider = (*mistapiProvider)(nil)
...
type mistapiProvider struct {
	version string
}
type mistapiProviderData struct {
	client *mistsdkgo.APIClient
}
type mistapiProviderModel struct {
	Host     types.String `tfsdk:"host"`
	Apitoken types.String `tfsdk:"apitoken"`
}

func (p *mistapiProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *mistapiProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
	var config mistapiProviderModel
...
func (p *mistapiProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "mistapi"
	resp.Version = p.version
}

func (p *mistapiProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{}
}

func (p *mistapiProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewOrgResource, NewSiteResource,
	}
}
