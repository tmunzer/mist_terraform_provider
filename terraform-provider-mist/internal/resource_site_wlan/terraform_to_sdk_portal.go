...
func portalTerraformToSdk(ctx context.Context, diags *diag.Diagnostics, plan PortalValue) *models.WlanPortal {
	...
	data.PortalAllowedHostnames = plan.PortalAllowedHostnames.ValueStringPointer()
	data.PortalAllowedSubnets = plan.PortalAllowedSubnets.ValueStringPointer()
	data.PortalApiSecret = plan.PortalApiSecret.ValueStringPointer()
	data.PortalDeniedHostnames = plan.PortalDeniedHostnames.ValueStringPointer()
