...
func usbConfigSdkToTerraform(ctx context.Context, diags *diag.Diagnostics, d mistapigo.ApUsb) UsbConfigValue {
	tflog.Debug(ctx, "usbConfigSdkToTerraform")

	r_attr_type := UsbConfigValue{}.AttributeTypes(ctx)
	...
	r, e := NewUsbConfigValue(r_attr_type, r_attr_value)
	diags.Append(e...)
	return r
}
