...
type IdpConfig struct {
	AlertOnly *string `json:"alert_only,omitempty"`
	Enabled *bool `json:"enabled,omitempty"`
	// org-level IDP Profile can be used, this takes precedence over `profile`
...
// SetAlertOnly gets a reference to the given string and assigns it to the AlertOnly field.
