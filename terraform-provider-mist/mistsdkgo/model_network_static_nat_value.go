...
// checks if the NetworkStaticNatValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkStaticNatValue{}

// NetworkStaticNatValue struct for NetworkStaticNatValue
type NetworkStaticNatValue struct {
...
type _NetworkStaticNatValue NetworkStaticNatValue
...
func (o NetworkStaticNatValue) MarshalJSON() ([]byte, error) {
...
func (o NetworkStaticNatValue) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkStaticNatValue) UnmarshalJSON(data []byte) (err error) {
	varNetworkStaticNatValue := _NetworkStaticNatValue{}

	err = json.Unmarshal(data, &varNetworkStaticNatValue)

	if err != nil {
		return err
	}

	*o = NetworkStaticNatValue(varNetworkStaticNatValue)
...
type NullableNetworkStaticNatValue struct {
	value *NetworkStaticNatValue
	isSet bool
}

func (v NullableNetworkStaticNatValue) Get() *NetworkStaticNatValue {
	return v.value
}

func (v *NullableNetworkStaticNatValue) Set(val *NetworkStaticNatValue) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkStaticNatValue) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkStaticNatValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkStaticNatValue(val *NetworkStaticNatValue) *NullableNetworkStaticNatValue {
	return &NullableNetworkStaticNatValue{value: val, isSet: true}
}

func (v NullableNetworkStaticNatValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkStaticNatValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
