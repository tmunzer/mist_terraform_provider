...
// checks if the GatewayRoutingPolicyItemMatching type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewayRoutingPolicyItemMatching{}

// GatewayRoutingPolicyItemMatching zero or more criteria/filter can be specified to match the term, all criteria have to be met
type GatewayRoutingPolicyItemMatching struct {
	...
	RouteExists *GatewayRoutingPolicyItemMatchingRouteExists `json:"route_exists,omitempty"`
	...
	VpnPathSla *GatewayRoutingPolicyItemMatchingVpnPathSla `json:"vpn_path_sla,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _GatewayRoutingPolicyItemMatching GatewayRoutingPolicyItemMatching
...
func NewGatewayRoutingPolicyItemMatching() *GatewayRoutingPolicyItemMatching {
	this := GatewayRoutingPolicyItemMatching{}
	return &this
}
...
func (o *GatewayRoutingPolicyItemMatching) GetRouteExists() GatewayRoutingPolicyItemMatchingRouteExists {
	if o == nil || IsNil(o.RouteExists) {
		var ret GatewayRoutingPolicyItemMatchingRouteExists
		return ret
	}
...
// SetRouteExists gets a reference to the given GatewayRoutingPolicyItemMatchingRouteExists and assigns it to the RouteExists field.
...
func (o *GatewayRoutingPolicyItemMatching) GetVpnPathSla() GatewayRoutingPolicyItemMatchingVpnPathSla {
	if o == nil || IsNil(o.VpnPathSla) {
		var ret GatewayRoutingPolicyItemMatchingVpnPathSla
		return ret
	}
	return *o.VpnPathSla
}
...
// SetVpnPathSla gets a reference to the given GatewayRoutingPolicyItemMatchingVpnPathSla and assigns it to the VpnPathSla field.
func (o *GatewayRoutingPolicyItemMatching) SetVpnPathSla(v GatewayRoutingPolicyItemMatchingVpnPathSla) {
	o.VpnPathSla = &v
}

func (o GatewayRoutingPolicyItemMatching) MarshalJSON() ([]byte, error) {
...
func (o GatewayRoutingPolicyItemMatching) ToMap() (map[string]interface{}, error) {
...
func (o *GatewayRoutingPolicyItemMatching) UnmarshalJSON(data []byte) (err error) {
	varGatewayRoutingPolicyItemMatching := _GatewayRoutingPolicyItemMatching{}

	err = json.Unmarshal(data, &varGatewayRoutingPolicyItemMatching)

	if err != nil {
		return err
	}

	*o = GatewayRoutingPolicyItemMatching(varGatewayRoutingPolicyItemMatching)
...
type NullableGatewayRoutingPolicyItemMatching struct {
	value *GatewayRoutingPolicyItemMatching
	isSet bool
}

func (v NullableGatewayRoutingPolicyItemMatching) Get() *GatewayRoutingPolicyItemMatching {
	return v.value
}

func (v *NullableGatewayRoutingPolicyItemMatching) Set(val *GatewayRoutingPolicyItemMatching) {
	v.value = val
	v.isSet = true
}

func (v NullableGatewayRoutingPolicyItemMatching) IsSet() bool {
	return v.isSet
}

func (v *NullableGatewayRoutingPolicyItemMatching) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGatewayRoutingPolicyItemMatching(val *GatewayRoutingPolicyItemMatching) *NullableGatewayRoutingPolicyItemMatching {
	return &NullableGatewayRoutingPolicyItemMatching{value: val, isSet: true}
}

func (v NullableGatewayRoutingPolicyItemMatching) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGatewayRoutingPolicyItemMatching) UnmarshalJSON(src []byte) error {
	v.isSet = true
