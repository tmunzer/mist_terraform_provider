...
// checks if the JunosSnmpConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JunosSnmpConfig{}

// JunosSnmpConfig struct for JunosSnmpConfig
type JunosSnmpConfig struct {
	ClientList []JunosSnmpConfigClientListInner `json:"client_list,omitempty"`
	...
	TrapGroups []JunosSnmpConfigTrapGroupsInner `json:"trap_groups,omitempty"`
	V2cConfig []SnmpV2cConfig `json:"v2c_config,omitempty"`
	V3Config *SnmpV3Config `json:"v3_config,omitempty"`
	Views *JunosSnmpConfigViews `json:"views,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _JunosSnmpConfig JunosSnmpConfig
...
func (o *JunosSnmpConfig) GetClientList() []JunosSnmpConfigClientListInner {
	if o == nil || IsNil(o.ClientList) {
		var ret []JunosSnmpConfigClientListInner
		return ret
	}
	return o.ClientList
}
...
// SetClientList gets a reference to the given []JunosSnmpConfigClientListInner and assigns it to the ClientList field.
...
func (o *JunosSnmpConfig) GetTrapGroups() []JunosSnmpConfigTrapGroupsInner {
	if o == nil || IsNil(o.TrapGroups) {
		var ret []JunosSnmpConfigTrapGroupsInner
		return ret
	}
	return o.TrapGroups
}
...
// SetTrapGroups gets a reference to the given []JunosSnmpConfigTrapGroupsInner and assigns it to the TrapGroups field.
...
// SetV2cConfig gets a reference to the given []SnmpV2cConfig and assigns it to the V2cConfig field.
...
// SetViews gets a reference to the given JunosSnmpConfigViews and assigns it to the Views field.
func (o *JunosSnmpConfig) SetViews(v JunosSnmpConfigViews) {
	o.Views = &v
}

func (o JunosSnmpConfig) MarshalJSON() ([]byte, error) {
...
func (o JunosSnmpConfig) ToMap() (map[string]interface{}, error) {
...
func (o *JunosSnmpConfig) UnmarshalJSON(data []byte) (err error) {
	varJunosSnmpConfig := _JunosSnmpConfig{}

	err = json.Unmarshal(data, &varJunosSnmpConfig)

	if err != nil {
		return err
	}

	*o = JunosSnmpConfig(varJunosSnmpConfig)
...
type NullableJunosSnmpConfig struct {
	value *JunosSnmpConfig
	isSet bool
}

func (v NullableJunosSnmpConfig) Get() *JunosSnmpConfig {
	return v.value
}

func (v *NullableJunosSnmpConfig) Set(val *JunosSnmpConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableJunosSnmpConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableJunosSnmpConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJunosSnmpConfig(val *JunosSnmpConfig) *NullableJunosSnmpConfig {
	return &NullableJunosSnmpConfig{value: val, isSet: true}
}

func (v NullableJunosSnmpConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJunosSnmpConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
