...
// checks if the GatewayTemplateTunnelConfigsProbe type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewayTemplateTunnelConfigsProbe{}

// GatewayTemplateTunnelConfigsProbe Only if: * `provider`== `custom-ipsec`
...
type _GatewayTemplateTunnelConfigsProbe GatewayTemplateTunnelConfigsProbe
...
func NewGatewayTemplateTunnelConfigsProbe() *GatewayTemplateTunnelConfigsProbe {
	this := GatewayTemplateTunnelConfigsProbe{}
...
func (o GatewayTemplateTunnelConfigsProbe) MarshalJSON() ([]byte, error) {
...
func (o GatewayTemplateTunnelConfigsProbe) ToMap() (map[string]interface{}, error) {
...
func (o *GatewayTemplateTunnelConfigsProbe) UnmarshalJSON(data []byte) (err error) {
	varGatewayTemplateTunnelConfigsProbe := _GatewayTemplateTunnelConfigsProbe{}

	err = json.Unmarshal(data, &varGatewayTemplateTunnelConfigsProbe)

	if err != nil {
		return err
	}

	*o = GatewayTemplateTunnelConfigsProbe(varGatewayTemplateTunnelConfigsProbe)
...
type NullableGatewayTemplateTunnelConfigsProbe struct {
	value *GatewayTemplateTunnelConfigsProbe
	isSet bool
}

func (v NullableGatewayTemplateTunnelConfigsProbe) Get() *GatewayTemplateTunnelConfigsProbe {
	return v.value
}

func (v *NullableGatewayTemplateTunnelConfigsProbe) Set(val *GatewayTemplateTunnelConfigsProbe) {
	v.value = val
	v.isSet = true
}

func (v NullableGatewayTemplateTunnelConfigsProbe) IsSet() bool {
	return v.isSet
}

func (v *NullableGatewayTemplateTunnelConfigsProbe) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGatewayTemplateTunnelConfigsProbe(val *GatewayTemplateTunnelConfigsProbe) *NullableGatewayTemplateTunnelConfigsProbe {
	return &NullableGatewayTemplateTunnelConfigsProbe{value: val, isSet: true}
}

func (v NullableGatewayTemplateTunnelConfigsProbe) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGatewayTemplateTunnelConfigsProbe) UnmarshalJSON(src []byte) error {
	v.isSet = true
