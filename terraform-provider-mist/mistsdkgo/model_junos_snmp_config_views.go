...
// checks if the JunosSnmpConfigViews type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JunosSnmpConfigViews{}

// JunosSnmpConfigViews struct for JunosSnmpConfigViews
type JunosSnmpConfigViews struct {
...
type _JunosSnmpConfigViews JunosSnmpConfigViews
...
func (o JunosSnmpConfigViews) MarshalJSON() ([]byte, error) {
...
func (o JunosSnmpConfigViews) ToMap() (map[string]interface{}, error) {
...
func (o *JunosSnmpConfigViews) UnmarshalJSON(data []byte) (err error) {
	varJunosSnmpConfigViews := _JunosSnmpConfigViews{}

	err = json.Unmarshal(data, &varJunosSnmpConfigViews)

	if err != nil {
		return err
	}

	*o = JunosSnmpConfigViews(varJunosSnmpConfigViews)
...
type NullableJunosSnmpConfigViews struct {
	value *JunosSnmpConfigViews
	isSet bool
}

func (v NullableJunosSnmpConfigViews) Get() *JunosSnmpConfigViews {
	return v.value
}

func (v *NullableJunosSnmpConfigViews) Set(val *JunosSnmpConfigViews) {
	v.value = val
	v.isSet = true
}

func (v NullableJunosSnmpConfigViews) IsSet() bool {
	return v.isSet
}

func (v *NullableJunosSnmpConfigViews) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJunosSnmpConfigViews(val *JunosSnmpConfigViews) *NullableJunosSnmpConfigViews {
	return &NullableJunosSnmpConfigViews{value: val, isSet: true}
}

func (v NullableJunosSnmpConfigViews) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJunosSnmpConfigViews) UnmarshalJSON(src []byte) error {
	v.isSet = true
