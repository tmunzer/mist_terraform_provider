...
DATA["components"]["schemas"]["mist_device"] = {'$ref': '#/components/schemas/device_gateway'}
DATA["components"]["schemas"]["deviceprofile"] = {'$ref': '#/components/schemas/deviceprofile_gateway'}
